...
class MainActivity : AppCompatActivity() {
    ...
    private val createDocument = registerForActivityResult(ActivityResultContracts.CreateDocument("image/png")) { uri ->
        uri?.let {
    ...
    private fun saveImageToUri(bitmap: Bitmap, uri: android.net.Uri) {
        try {
            ...
            // Handle error with a user notification
            runOnUiThread {
